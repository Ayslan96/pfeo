...
AnfibioExotico::AnfibioExotico(int m_codigo, int m_id, string m_classe, string m_nome_cientifico, char m_sexo, int m_tamanho, string m_dieta, string m_nome_batismo,
		bool m_veterinario, bool m_tratador, int m_total_de_mudas, Date m_ultima_muda, string m_autorizacao_ibama, string m_pais_origem):
...
*/
	...
	void AnfibioExotico::setM_veterinario(bool veterinario){
		m_veterinario = veterinario;
	}
	void AnfibioExotico::setM_funcionario(bool tratador){
		m_tratador = tratador;
	}
