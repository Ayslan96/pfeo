...
void AnfibioNativo::imprime(){
	...
	void AnfibioNativo::setM_veterinario(bool veterinario){
		m_veterinario = veterinario;
	}
	void AnfibioNativo::setM_funcionario(bool tratador){
		m_tratador = tratador;
	}
	...
	bool AnfibioNativo::getM_veterinario(){
		return m_veterinario;
	}

	bool AnfibioNativo::getM_tratador(){
		return m_tratador;
	}
