...
* @brief Métodos da Classe MamiferoNativo
*/

/** @brief Inclui a biblioteca mamiferonativo.h */
...
MamiferoNativo::MamiferoNativo(int m_codigo, int m_id, std::string m_classe, std::string m_nome_cientifico, char m_sexo, int m_tamanho, std::string m_dieta, std::string m_nome_batismo,
		bool m_veterinario, bool m_tratador, std::string m_cor_pelo, std::string m_autorizacao_ibama, std::string m_uf_origem, std::string m_cidade_origem):
		Mamifero
