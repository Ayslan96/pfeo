...
* @brief Métodos da Classe ReptilExotico filha da classe base Reptil
*/

/** @brief Inclui a biblioteca reptilexotico.h */
...
/**
* @brief Método de impressão de um ReptilExotico.
* @return Não possui retorno
*/
