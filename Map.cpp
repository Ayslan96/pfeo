...
int main(int argc, char *argv[])
{
	...
	mapa[1] = "joao"; //adiciona joao a chave 1
	mapa[2] = "maria"; // add maria a chave 2
	mapa[3] = "pedro"; // add predo a chave 3

	// alterando o valor associado a uma chave
	mapa.at(1) = "carol";

	if(mapa.empty()) //testa se mapa está vazio
		cout << "Mapa vazio!!\n" << endl;
	else
		cout << "Mapa NAO vazio!!\n" << endl;
