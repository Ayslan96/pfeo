...
public:
	Ave(void);
	Ave(int id, string classe, string nome_cientifico, char sexo, int tamanho, string dieta, string nome_batismo, double tamanho_do_bico_cm, double envergadura_das_asas);
	~Ave();
	void imprime();
